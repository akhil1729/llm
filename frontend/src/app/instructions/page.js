...
export default function InstructionsPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center text-white bg-black overflow-hidden">
      ...
      {/* Instructions Card */}
      <div
        className="relative z-10 w-full max-w-3xl p-10 bg-white/10 border border-white/20 backdrop-blur-lg rounded-2xl shadow-2xl hover:shadow-green-400/20 transition duration-500"
        data-aos="fade-up"
      >
